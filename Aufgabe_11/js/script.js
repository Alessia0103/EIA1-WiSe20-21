...
function updateCounter() {
    var open = 0;
    var done = 0;
    for (var id = 0; id < arraytodo.length; id++) {
      if(arraytodo[id].checked == true){
          done++
      }
      else (open++);
    }

    counterDOMElement.innerHTML = arraytodo.length + " in total, " + open + " open tasks, " + done + " tasks done";
}
/**
...
function addTodo() {
    ...
    if (inputDOMElement.value != "") {
         ...
         */
        /** mit unshift wird das element am anfang des arrays hinzugefügt  */
        arraytodo.unshift({
