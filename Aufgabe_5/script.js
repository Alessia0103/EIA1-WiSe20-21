...
console.log( "Für Africa hat sich 2018 im Vergleich zu 2008 die Emission um " + ( africa18 / africa08 * 100) + "% verändert");
console.log( "2018 im Vergleich zu 2008 sind das " + ( africa18 - africa08 ) + "kg CO2");
console.log( "Für South America hat sich 2018 im Vergleich zu 2008 die Emission um " + ( southa18 / southa08 * 100) + "% verändert");
console.log( "2018 im Vergleich zu 2008 sind das " + ( southa18 - southa08 ) + "kg CO2");
console.log( "Für North America hat sich 2018 im Vergleich zu 2008 die Emission um " + ( northa18 / northa08 * 100) + "% verändert");
console.log( "2018 im Vergleich zu 2008 sind das " + ( northa18 - northa08 ) + "kg CO2");
console.log( "Für Asia hat sich 2018 im Vergleich zu 2008 die Emission um " + ( asia18 / asia08 * 100) + "% verändert");
